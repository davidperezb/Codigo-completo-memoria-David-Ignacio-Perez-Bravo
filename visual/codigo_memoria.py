...
Anexo B - Código fuente completo (módulos B.1 a B.8)
...
class ResultadoFinal:
    """
    Resultado consolidado que entrega la herramienta (Sección 5.2).
...
def evaluar_sitio(esdd, nsdd, entorno, hr, viento, lluvia, un, linst,
    ...
    Nota sobre 'altitud': variable MECÁNICA (ver nota de módulo B.5). Se
...
# B.8 - CLI interactivo
# =============================================================================
# NOTA DE VERSIÓN: la altitud del sitio ahora se pide en la sección de
# "Datos mecánicos" (junto con perfil, geometría, s/p y S), y no en
# "Datos eléctricos", consistente con el cambio aplicado en B.5/B.6/B.7.
# =============================================================================
