...
def clasificar_sps(esdd, nsdd):
    ...
    o simulados, según la Tabla 3.1 (adaptación operacional de
    IEC TS 60815-1:2008).
    ...
    soluble (NSDD) controla la retención de humedad (Sección 3.3.1).
    ...
    # Se adopta el nivel más restrictivo entre ambos criterios
